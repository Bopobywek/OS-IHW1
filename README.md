...
- [Критерии на 10 баллов](#%D0%BA%D1%80%D0%B8%D1%82%D0%B5%D1%80%D0%B8%D0%B8-%D0%BD%D0%B0-10-%D0%B1%D0%B0%D0%BB%D0%BB%D0%BE%D0%B2)
  * [Общая схема решаемой задачи](#%D0%BE%D0%B1%D1%89%D0%B0%D1%8F-%D1%81%D1%85%D0%B5%D0%BC%D0%B0-%D1%80%D0%B5%D1%88%D0%B0%D0%B5%D0%BC%D0%BE%D0%B9-%D0%B7%D0%B0%D0%B4%D0%B0%D1%87%D0%B8-6)
  * [Исходный код](#%D0%B8%D1%81%D1%85%D0%BE%D0%B4%D0%BD%D1%8B%D0%B9-%D0%BA%D0%BE%D0%B4-6)
  * [Замечание](#%D0%B7%D0%B0%D0%BC%D0%B5%D1%87%D0%B0%D0%BD%D0%B8%D0%B5)
  * [Результаты работы](#%D1%80%D0%B5%D0%B7%D1%83%D0%BB%D1%8C%D1%82%D0%B0%D1%82%D1%8B-%D1%80%D0%B0%D0%B1%D0%BE%D1%82%D1%8B-6)
...
### Результаты работы
Доработана программы на 8 баллов, теперь размер буфера составляет не 5000 байт, а 100. Так как изначально была построена удачная структура программ, для доработки только пришлось лишь изменить значение константы в `constants.h`


## Критерии на 10 баллов
### Общая схема решаемой задачи
<p align="center">
<img src="grade10/pictures/scheme.png">
</p>

### Исходный код

Исходный код располагается в папке [grade10/](grade10/)  

### Замечание
На WSL очереди работают некорректно :(  
  Поэтому тестирование программ проводил на виртуальной машине под Ubuntu. На всякий случай, прилагаю успешные результаты запуска чекера:
  <p align="center">
<img src="grade10/pictures/verification.png">
</p>  


### Результаты работы
Написаны программы, которые общаются между собой посредством очереди сообщений. Длина сообщения составляет 101 байт, где 1 байт отводится на хранение длины строки, остальные 100 байт могут быть заняты символами.