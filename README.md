...
### Замечание
На WSL очереди работают некорректно, их тестирование проводил на виртуальной машине под Ubuntu. На всякий случай, прилагаю успешные результаты тестирования
